    ...
    <div className="p-6 max-w-4xl mx-auto space-y-10">
      ...
      <section>
        ...
        <div className="bg-wb-dark-02 rounded-lg p-6 overflow-x-auto mb-4">
          <table className="w-full">
            <thead>
              <tr>
                <th className="text-left text-xs text-wb-grey-02 pb-3 pr-4">Size</th>
                {WATCH_STATUSES.map((s) => (
                  <th key={s} className="text-center text-xs text-wb-grey-02 pb-3 px-2">
            ...
            <tbody>
              {SIZES.map((size) => (
                <tr key={size}>
                  <td className="text-xs text-wb-grey-03 py-2 pr-4 whitespace-nowrap">
        ...
        <div className="bg-neutral-100 rounded-lg p-4 text-sm text-neutral-700 space-y-1">
          ...
          <p>outline — EyeOutline, text-wb-grey-03 (#B1B1B1)</p>
        </div>
      </section>
        ...
        <div className="bg-wb-dark-02 rounded-lg p-6 mb-4">
          <table className="w-full">
            <thead>
              <tr>
                <th className="text-left text-xs text-wb-grey-02 pb-3 pr-4">Size</th>
                <th className="text-center text-xs text-wb-grey-02 pb-3 px-4">Active</th>
                <th className="text-center text-xs text-wb-grey-02 pb-3 px-4">Inactive</th>
              </tr>
            </thead>
            <tbody>
              {SIZES.map((size) => (
                <tr key={size}>
                  <td className="text-xs text-wb-grey-03 py-2 pr-4">
                    {size} ({SIZE_LABELS[size]})
                  </td>
      ...
      <section>
          ...
          <table className="w-full">
            <thead>
              <tr>
                <th className="text-left text-xs text-wb-grey-02 pb-3 pr-4">Size</th>
                {BOX_VARIANTS.map((v) => (
                  <th key={v} className="text-center text-xs text-wb-grey-02 pb-3 px-3">
        ...
        <div className="bg-neutral-100 rounded-lg p-4 text-sm text-neutral-700 space-y-1">
          <p className="font-semibold text-black mb-2">디자인 스펙</p>
          <p>사이즈 — xl:48px, large:32px, medium:24px, small:20px, tiny:12px</p>
          <p>added — ArchiveBoxSolid, text-wb-grey-04 (#D9D9D9)</p>
          <p>none — ArchiveBoxSolid, text-wb-grey-01 (#525252)</p>
          <p>outline — ArchiveBoxOutline, text-wb-grey-03 (#B1B1B1)</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="bg-wb-dark-02 rounded-lg p-6 flex items-center gap-8 mb-4">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-wb-grey-02">grey</span>
          </div>
        </div>
        ...
        <div className="bg-neutral-100 rounded-lg p-4 text-sm text-neutral-700 space-y-1">
          <p className="font-semibold text-black mb-2">디자인 스펙</p>
          <p>사이즈 — 24px 고정</p>
          <p>light — XMarkOutline, text-wb-grey-04 (#D9D9D9)</p>
          <p>grey — XMarkOutline, text-wb-grey-01 (#525252)</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="bg-wb-dark-02 rounded-lg p-6 flex items-center gap-8 mb-4">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-wb-grey-02">add</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <AddedStatusIcon variant="checked" />
            <span className="text-xs text-wb-grey-02">checked</span>
          </div>
        </div>
      ...
      <section>
        ...
        <div className="bg-wb-dark-02 rounded-lg p-6 flex items-center gap-8 mb-4">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-wb-grey-02">list (28px)</span>
          </div>
        </div>
